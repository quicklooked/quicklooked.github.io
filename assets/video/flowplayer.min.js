  ...
  return function e(t, n, i) {
          ...
          g = {
            ...
            load: function(i) {
              ...
              if(b || C || (w = o.createAbsoluteUrl(w)), f && m(i) && f.data !== o.createAbsoluteUrl(p.swfHls) && g.unload(), f) {
                ...
                void 0 !== E && (S.hlsQualities = E ? encodeURIComponent(JSON.stringify(E)) : E), void 0 !== p.bufferTime && (S.bufferTime = p.bufferTime), void 0 !== p.bufferTimeMax && (S.bufferTimeMax = p.bufferTimeMax), b && delete S.rtmp, S.rtmp && (S.rtmp = v(S.rtmp));
    ...
    4: [function(e, t, n) {
      ...
      function u(e) {
        ...
        var n, o, c = window.Hls;
        return l("hlsjs-lite", e, t, u, function(l, u, f) {
          var d = r.extend({
            recoverMediaError: !0
          }, e.conf.hlsjs, l.hlsjs);
          e.engine.hls && e.engine.hls.destroy();
          var p, h, g = e.engine.hls = new c(d);
          ...
          }), g.loadSource(l.src), f.resume = function() {
            e.live && !e.dvr && (u.currentTime = g.liveSyncPosition || 0), u.play()
          }, f.seek = function(t) {
            try {
              e.live || e.dvr ? u.currentTime = Math.min(t, g.liveSyncPosition || u.duration - d.livePositionOffset) : u.currentTime = t
            }
            catch (n) {
              e.debug("Failed to seek to ", t, n)
            }
          }, !1 === d.bufferWhilePaused && e.on("pause", function() {
            g.stopLoad(), e.one("resume", function() {
              g.startLoad()
            })
          ...
          var m = function(n) {
            if(e.debug("hlsjs - recovery"), a.removeClass(t, "is-paused"), a.addClass(t, "is-seeking"), s.one(u, "seeked", function() {
              ...
              }), n) return g.startLoad();
            var i = performance.now();
            !p || i - p > 3e3 ? (p = performance.now(), g.recoverMediaError()) : (!h || i - h > 3e3) && (h = performance.now(), g.swapAudioCodec(), g.recoverMediaError())
          };
          return g.on(c.Events.MANIFEST_PARSED, function(t, i) {
            var r, s = l.hlsQualities || e.conf.hlsQualities,
              c = {},
              f = i.levels;
            if(!1 === s) return g.attachMedia(u);
            if("drive" === s) switch(f.length) {
              case 4:
                r = [1, 2, 3];
                break;
              case 5:
              ...
              case 8:
                ...
                break;
              default:
                r = f.length < 3 || f[0].height && f[2].height && f[0].height === f[2].height ? [] : [1, 2]
            }
            if(l.qualities = [{
                value: -1,
                label: "Auto"
              ...
              d ? l.qualities[0].label = "number" != typeof d ? d.label : l.qualities[0].label : l.qualities = [], r = s.map(function(e) {
                return void 0 !== e.level && (c[e.level] = e.label), void 0 !== e.level ? e.level : e
              })
            }
            var p = -2;
            l.qualities = l.qualities.concat(f.map(function(e, t) {
              if(r && -1 === r.indexOf(t)) return !1;
              var i = c[t] || Math.min(e.width, e.height) + "p";
              return c[t] || "drive" === s || (i += " (" + Math.round(e.bitrate / 1e3) + "k)"), t === n && (p = t), {
                value: t,
                label: i
              }
            })).filter(a.identity);
            var h = l.quality = -2 === p ? l.qualities[0].value || -1 : p;
            h !== g.currentLevel && (g.currentLevel = h), g.attachMedia(u), o && l.src !== o && u.play(), o = l.src
          }), g.on(c.Events.ERROR, function(t, n) {
            if(n.fatal)
              if(d.recoverNetworkError && n.type === c.ErrorTypes.NETWORK_ERROR) m(!0);
              else if(d.recoverMediaError && n.type === c.ErrorTypes.MEDIA_ERROR) m(!1);
            else {
              var i = 5;
              n.type === c.ErrorTypes.NETWORK_ERROR && (i = 2), n.type === c.ErrorTypes.MEDIA_ERROR && (i = 3), g.destroy(), e.trigger("error", [e, {
                code: i
              }])
            }
            ...
            handlers: {
              error: function(e, t) {
                ...
                return d.recoverMediaError && 3 === n || !n ? (e.preventDefault(), m(!1), !0) : d.recoverNetworkError && 2 === n ? (e.preventDefault(), m(!0), !0) : void 0
              }
            }
          }
        })
      }).canPlay = function(e, t) {
        return !(!1 === t.hlsjs || t.clip && !1 === t.clip.hlsjs) && (!(o.browser.safari && !(t.clip && t.clip.hlsjs || t.hlsjs || {}).safari) && (r.support.video && u(e)))
        ...
        return p = {
          ...
          load: function(e) {
            ...
            if(g.autoplay || g.splash || e.autoplay) {
              t.debug("Autoplay / Splash setup, try to start video"), h.load();
              var b = function() {
                try {
                  var e = h.play();
                  if(e && e.catch) {
                    var n = function(e) {
                      if("AbortError" === e.name && 20 === e.code) return m ? void 0 : h.play().catch(n);
              ...
              h.readyState > 0 ? b() : a.one(h, "canplay", b)
            }
    ...
    18: [function(e, t, n) {
      ...
      (l.touch || r) && i(function(e, t) {
        ...
        var v = !0;
        if(a.on(t, "touchend click", function(n) {
            if(m) m = !1;
            else {
              var i = o.find("video.fp-engine", t)[0];
              if(v && e.conf.clickToUnMute && i && i.muted && e.conf.autoplay && (i.muted = !1), v = !1, e.playing && !o.hasClass(t, "is-mouseover")) return o.addClass(t, "is-mouseover"), o.removeClass(t, "is-mouseout"), n.preventDefault(), void n.stopPropagation();
          ...
          var n = o.find("video.fp-engine", t)[0];
          e.conf.splash && n.paused && "hlsjs-lite" !== e.engine.engineName && (a.one(n, "canplay", function() {
            n.play()
        ...
        if(!1 !== n.share) {
          e.shareUrl = function(t) {
            ...
            var i = encodeURIComponent(e.video.title || (r.find("title")[0] || {}).innerHTML || "Flowplayer video"),
              a = encodeURIComponent(btoa(JSON.stringify(o({}, e.conf, e.extensions)).replace(/[\u007F-\uFFFF]/g, function(e) {
                return "\\u" + ("0000" + e.charCodeAt(0).toString(16)).substr(-4)
              }))),
              s = encodeURIComponent(window.location.toString());
            return (t ? "https://flowplayer.com/e/" : "https://flowplayer.com/s/") + "?t=" + i + "&c=" + a + "&r=" + s
          };
        ...
        e.disableSubtitles = function() {
          ...
          if(n) {
            if(c(t), !i.support.subtitles || !e.conf.nativesubtitles || "html5" != e.engine.engineName) return r.xhrGet(n, function(t) {
              e.conf.subtitleParser(t).forEach(function(t, n) {
                ...
                e.subtitles.push(t), e.addCuepoint(r), e.addCuepoint({
                  time: t.endTime,
                  subtitleEnd: t.title,
                  visible: !1
                }), 0 !== t.startTime || e.video.time || e.splash || e.trigger("cuepoint", [e, i.extend({}, r, {
                  index: 0
                })]), e.splash && e.one("ready", function() {
                  e.trigger("cuepoint", [e, r])
                })
              })
            }, function() {
      ...
      (function(n) {
        ...
        i(function(e, t) {
          ...
          if("string" == typeof C.splash && r.css(t, "background-image", "url('" + C.splash + "')"), !X && e.forcedSplash && r.css(t, "background-color", "#555"), o.on(t, "click", ".fp-toggle, .fp-play, .fp-playbtn", function() {
            ...
            var K = r.find(".fp-player", t)[0] || t,
              Q = function() {
                r.toggleClass(t, "is-tiny", K.clientWidth < 400), r.toggleClass(t, "is-small", K.clientWidth < 600 && K.clientWidth >= 400), H = window.requestAnimationFrame(Q)
              };
            H = window.requestAnimationFrame(Q)
          }
        }), t.exports.format = u
          ...
          7 !== w && (p || t).appendChild(y), e.on("pause resume finish unload ready", function(e, n) {
            ...
            if(n.video.src)
              for(var o = [
                  ...
                  ["org", "flowplayer", "cdn"],
                  ["com", "flowplayer", "cdn"]
                ], a = 0; a < o.length && (r = n.video.src.indexOf("://" + o[a].reverse().join(".")), -1 === r); a++);
    ...
    33: [function(e, t, n) {
      ...
      n.byteLength = function(e) {
        ...
        var t, n, i, a, s, l, c = e.length;
        s = u(e), l = new o(3 * c / 4 - s), i = s > 0 ? c - 4 : c;
        var f = 0;
        for(t = 0, n = 0; t < i; t += 4, n += 3) a = r[e.charCodeAt(t)] << 18 | r[e.charCodeAt(t + 1)] << 12 | r[e.charCodeAt(t + 2)] << 6 | r[e.charCodeAt(t + 3)], l[f++] = a >> 16 & 255, l[f++] = a >> 8 & 255, l[f++] = 255 & a;
        2 === s ? (a = r[e.charCodeAt(t)] << 2 | r[e.charCodeAt(t + 1)] >> 4, l[f++] = 255 & a) : 1 === s && (a = r[e.charCodeAt(t)] << 10 | r[e.charCodeAt(t + 1)] << 4 | r[e.charCodeAt(t + 2)] >> 2, l[f++] = a >> 8 & 255, l[f++] = 255 & a);
        return l
      ...
      function c(e, t, n) {
        for(var r, o, a = [], s = t; s < n; s += 3) r = (e[s] << 16) + (e[s + 1] << 8) + e[s + 2], a.push(i[(o = r) >> 18 & 63] + i[o >> 12 & 63] + i[o >> 6 & 63] + i[63 & o]);
        return a.join("")
      }
    ...
    35: [function(e, t, n) {
      (function(t) {
        ...
        n.Buffer = l, n.SlowBuffer = function(e) {
          ...
          for(var o = r - i, a = n - t, s = Math.min(o, a), u = this.slice(i, r), c = e.slice(t, n), f = 0; f < s; ++f)
            if(u[f] !== c[f]) {
              o = u[f], a = c[f];
              break
    ...
    38: [function(e, t, n) {
      ! function(e, i) {
        ...
        var W = y.bind(o.hasOwnProperty),
          ...
          V = y.bind(u.indexOf),
          X = y.bind(h),
          _ = y.bind(o.propertyIsEnumerable),
          K = y.bind(i.sort),
        ...
        Z(i, {
          ...
          filter: function(e) {
            ...
            for(var l = 0; l < a; l++) l in o && (n = o[l], (void 0 === i ? e(n, l, r) : e.call(i, n, l, r)) && X(s, n));
            return s
          }
        }, !te(i.filter)), Z(i, {
          every: function(e) {
        ...
        var oe = i.lastIndexOf && -1 !== [0, 1].lastIndexOf(0, -3);
        Z(i, {
        ...
        var ae, se, le = (se = (ae = [1, 2]).splice(), 2 === ae.length && Q(se) && 0 === se.length);
        Z(i, {
          splice: function(e, t) {
            return 0 === arguments.length ? [] : p.apply(this, arguments)
          }
        }, !le);
        var ue, ce = (ue = {}, i.splice.call(ue, 0, 0, 1), 1 === ue.length);
        Z(i, {
          splice: function(e, t) {
            if(0 === arguments.length) return [];
            var n = arguments;
            return this.length = b(Y(this.length), 0), arguments.length > 0 && "number" != typeof t && ((n = J(arguments)).length < 2 ? X(n, this.length - e) : n[1] = Y(t)), p.apply(this, n)
          }
        }, !ce);
        var fe, de, pe = ((fe = new n(1e5))[8] = "x", fe.splice(1, 1), 7 === fe.indexOf("x")),
          he = ((de = [])[256] = "a", de.splice(257, 0, "b"), "a" === de[256]);
        Z(i, {
          splice: function(e, t) {
        ...
        ge && Z(i, {
          join: function(e) {
            var n = void 0 === e ? "," : e;
            return me.call(t(this) ? H(this, "") : this, n)
          }
        }, ge);
        ...
        var ye, we = function(e) {
          ...
          be = (ye = {}, 1 !== Array.prototype.push.call(ye, void 0) || 1 !== ye.length || void 0 !== ye[0] || !W(ye, 0));
        Z(i, {
          push: function(e) {
            return Q(this) ? h.apply(this, arguments) : we.apply(this, arguments)
          }
        }, be);
        var Ie, Me = 1 !== (Ie = []).push(void 0) || 1 !== Ie.length || void 0 !== Ie[0] || !W(Ie, 0);
        Z(i, {
          push: we
        }, Me), Z(i, {
          slice: function(e, n) {
            var i = t(this) ? H(this, "") : this;
        ...
        var Ee = !_({
          ...
          xe = function() {
            ...
            for(var e in window) try {
              !Le["$" + e] && W(window, e) && null !== window[e] && "object" == typeof window[e] && je(window[e])
            }
            catch (e) {
              return !0
            }
          ...
          ke = Pe(arguments) ? Pe : function(e) {
            return null !== e && "object" == typeof e && "number" == typeof e.length && e.length >= 0 && !Q(e) && D(e.callee)
          };
        Z(r, {
          keys: function(e) {
            var n = D(e),
            ...
            var a = [],
              s = De && n;
            if(o && Ne || i)
              for(var u = 0; u < e.length; ++u) X(a, l(u));
            if(!i)
              for(var c in e) s && "prototype" === c || !W(e, c) || X(a, l(c));
            if(Ee)
              for(var f = function(e) {
                  if("undefined" == typeof window || !xe) return je(e);
                  try {
                    return je(e)
                  }
                  catch (e) {
                ...
                var p = Te[d];
                f && "constructor" === p || !W(e, p) || X(a, p)
              }
            return a
          }
        });
        var Ye = r.keys && function() {
        ...
        Z(r, {
          keys: function(e) {
            return ke(e) ? Ge(J(e)) : Ge(e)
          }
        }, !Ye || ze);
        var Re, Oe, We = 0 !== new Date(-0xc782b5b342b24).getUTCMonth(),
          Ue = new Date(-0x55d318d56a724),
          Je = new Date(14496624e5),
          Be = "Mon, 01 Jan -45875 11:59:59 GMT" !== Ue.toUTCString();
        Ue.getTimezoneOffset() < -720 ? (Re = "Tue Jan 02 -45875" !== Ue.toDateString(), Oe = !/^Thu Dec 10 2015 \d\d:\d\d:\d\d GMT[-\+]\d\d\d\d(?: |$)/.test(Je.toString())) : (Re = "Mon Jan 01 -45875" !== Ue.toDateString(), Oe = !/^Wed Dec 09 2015 \d\d:\d\d:\d\d GMT[-\+]\d\d\d\d(?: |$)/.test(Je.toString()));
        var Fe = y.bind(Date.prototype.getFullYear),
          He = y.bind(Date.prototype.getMonth),
          Ve = y.bind(Date.prototype.getDate),
          Xe = y.bind(Date.prototype.getUTCFullYear),
          _e = y.bind(Date.prototype.getUTCMonth),
          Ke = y.bind(Date.prototype.getUTCDate),
          Qe = y.bind(Date.prototype.getUTCDay),
          qe = y.bind(Date.prototype.getUTCHours),
          $e = y.bind(Date.prototype.getUTCMinutes),
        ...
        Z(Date.prototype, {
          ...
          getDate: function() {
            ...
            var e = Fe(this),
              t = He(this),
              n = Ve(this);
            return e < 0 && t > 11 ? 12 === t ? n : rt(0, e + 1) - n + 1 : n
          },
          getUTCFullYear: function() {
            if(!(this && this instanceof Date)) throw new TypeError("this is not a Date object.");
            var e = Xe(this);
            return e < 0 && _e(this) > 11 ? e + 1 : e
          },
          ...
          toUTCString: function() {
            ...
            var e = Qe(this),
              ...
              o = $e(this),
              a = et(this);
            return nt[e] + ", " + (t < 10 ? "0" + t : t) + " " + it[n] + " " + i + " " + (r < 10 ? "0" + r : r) + ":" + (o < 10 ? "0" + o : o) + ":" + (a < 10 ? "0" + a : a) + " GMT"
          }
        }, We || Be), Z(Date.prototype, {
          toDateString: function() {
            ...
            var e = this.getDay(),
              ...
              n = this.getMonth(),
              i = this.getFullYear();
            return nt[e] + " " + it[n] + " " + (t < 10 ? "0" + t : t) + " " + i
          }
        }, We || Re), (We || Oe) && (Date.prototype.toString = function() {
          if(!(this && this instanceof Date)) throw new TypeError("this is not a Date object.");
          var e = this.getDay(),
            t = this.getDate(),
            n = this.getMonth(),
          ...
          return nt[e] + " " + it[n] + " " + (t < 10 ? "0" + t : t) + " " + i + " " + (r < 10 ? "0" + r : r) + ":" + (o < 10 ? "0" + o : o) + ":" + (a < 10 ? "0" + a : a) + " GMT" + (s > 0 ? "-" : "+") + (l < 10 ? "0" + l : l) + (u < 10 ? "0" + u : u)
        ...
        var ot = -621987552e5,
          at = "-000001",
          st = Date.prototype.toISOString && -1 === new Date(ot).toISOString().indexOf(at),
        ...
        Z(Date.prototype, {
            toISOString: function() {
              ...
              var e = Xe(this),
                t = _e(this);
              e += Math.floor(t / 12);
              var n = [(t = (t % 12 + 12) % 12) + 1, Ke(this), qe(this), $e(this), et(this)];
              e = (e < 0 ? "-" : e > 9999 ? "+" : "") + F("00000" + Math.abs(e), 0 <= e && e <= 9999 ? -4 : -6);
              for(var i = 0; i < n.length; ++i) n[i] = F("00" + n[i], -2);
              return e + "-" + J(n, 0, 2).join("-") + "T" + J(n, 2).join(":") + "." + F("000" + tt(this), -3) + "Z"
            }
          }, st || lt),
          function() {
            try {
        ...
        if(isNaN(Date.parse("2000-01-01T00:00:00.000Z")) || ft || !ct) {
          var dt = Math.pow(2, 31) - 1,
            pt = k(new Date(1970, 0, 1, 0, 0, 0, dt + 1).getTime());
          Date = function(e) {
        ...
        var ht = f.toFixed && ("0.000" !== 8e-5.toFixed(3) || "1" !== .9.toFixed(0) || "1.25" !== 1.255.toFixed(2) || "1000000000000000128" !== (0xde0b6b3a7640080).toFixed(0)),
          gt = {
            base: 1e7,
            size: 6,
            data: [0, 0, 0, 0, 0, 0],
            multiply: function(e, t) {
              for(var n = -1, i = t; ++n < gt.size;) i += e * gt.data[n], gt.data[n] = i % gt.base, i = Math.floor(i / gt.base)
            },
            divide: function(e) {
        ...
        Z(f, {
          toFixed: function(e) {
            ...
            if(i = "", n < 0 && (i = "-", n = -n), r = "0", n > 1e-21)
              if(a = (o = gt.log(n * gt.pow(2, 69, 1)) - 69) < 0 ? n * gt.pow(2, -o, 1) : n / gt.pow(2, o, 1), a *= 4503599627370496, (o = 52 - o) > 0) {
                for(gt.multiply(0, a), s = t; s >= 7;) gt.multiply(1e7, 0), s -= 7;
                for(gt.multiply(gt.pow(10, s, 1), 0), s = o - 1; s >= 23;) gt.divide(1 << 23), s -= 23;
                gt.divide(1 << s), gt.multiply(1, 1), gt.divide(2), r = gt.numToString()
              }
            else gt.multiply(0, a), gt.multiply(1 << -o, 0), r = gt.numToString() + F("0.00000000000000000000", 2, 2 + t);
            return r = t > 0 ? (u = r.length) <= t ? i + F("0.0000000000000000000", 0, t - u + 2) + r : i + F(r, 0, u - t) + "." + F(r, u - t) : i + r
          }
        }, ht);
        ...
        Z(f, {
          toPrecision: function(e) {
            return void 0 === e ? wt.call(this) : wt.call(this, e)
          }
        }, yt), 2 !== "ab".split(/(?:ab)*/).length || 4 !== ".".split(/(.?)(.?)/).length || "t" === "tesst".split(/(s)*/)[1] || 4 !== "test".split(/(?:)/, -1).length || "".split(/.?/).length || ".".split(/()()/).length > 1 ? (mt = void 0 === /()??/.exec("")[1], vt = Math.pow(2, 32) - 1, u.split = function(t, n) {
          var i = String(this);
          if(void 0 === t && 0 === n) return [];
          if(!e(t)) return H(this, t, n);
          var r, o, a, s, l = [],
            u = (t.ignoreCase ? "i" : "") + (t.multiline ? "m" : "") + (t.unicode ? "u" : "") + (t.sticky ? "y" : ""),
            c = 0,
            f = new RegExp(t.source, u + "g");
          mt || (r = new RegExp("^" + f.source + "$(?!\\s)", u));
          var d = void 0 === n ? vt : R(n);
          for(o = f.exec(i); o && !((a = o.index + o[0].length) > c && (X(l, F(i, c, o.index)), !mt && o.length > 1 && o[0].replace(r, function() {
          ...
          return c === i.length ? !s && f.test("") || X(l, "") : X(l, F(i, c)), l.length > d ? J(l, 0, d) : l
        }) : "0".split(void 0, 0).length && (u.split = function(e, t) {
          return void 0 === e && 0 === t ? [] : H(this, e, t)
        });
        var bt, It = u.replace;
        (bt = [], "x".replace(/x(.)?/g, function(e, t) {
          X(bt, t)
        }), 1 === bt.length && void 0 === bt[0]) || (u.replace = function(t, n) {
          var i = D(n),
            r = e(t) && /\)[*?]/.test(t.source);
          if(i && r) {
            return It.call(this, t, function(e) {
              var i = arguments.length,
                r = t.lastIndex;
              t.lastIndex = 0;
              var o = t.exec(e) || [];
              return t.lastIndex = r, X(o, arguments[i - 2], arguments[i - 1]), n.apply(this, o)
            })
          }
        ...
        Z(u, {
          substr: function(e, t) {
            var n = e;
            return e < 0 && (n = b(this.length + e, 0)), Mt.call(this, n, t)
          }
        }, Ct);
        var At = "\t\n\v\f\r   ᠎             　\u2028\u2029\ufeff",
          St = "[" + At + "]",
          Et = new RegExp("^" + St + St + "*"),
          Dt = new RegExp(St + St + "*$"),
          Nt = u.trim && (At.trim() || !"​".trim());
        Z(u, {
          trim: function() {
            if(void 0 === this || null === this) throw new TypeError("can't convert " + this + " to object");
            return l(this).replace(Et, "").replace(Dt, "")
          }
        }, Nt);
        var jt = y.bind(String.prototype.trim),
          Lt = u.lastIndexOf && -1 !== "abcあい".lastIndexOf("あい", 2);
        Z(u, {
          lastIndexOf: function(e) {
            if(void 0 === this || null === this) throw new TypeError("can't convert " + this + " to object");
        ...
        var xt, Tt, Zt, Pt = u.lastIndexOf;
        if(Z(u, {
            lastIndexOf: function(e) {
              return Pt.apply(this, arguments)
            }
          }, 1 !== u.lastIndexOf.length), 8 === parseInt(At + "08") && 22 === parseInt(At + "0x16") || (parseInt = (xt = parseInt, Tt = /^[\-+]?0[xX]/, function(e, t) {
            var n = jt(String(e)),
              i = c(t) || (Tt.test(n) ? 16 : 10);
            return xt(n, i)
          })), 1 / parseFloat("-0") != -1 / 0 && (parseFloat = (Zt = parseFloat, function(e) {
            var t = jt(String(e)),
              n = Zt(t);
            return 0 === n && "-" === F(t, 0, 1) ? -0 : n
      ...
      ! function(e, n) {
        ...
        function h(t, n, i) {
          ...
          function y() {
            if(!--m) {
              l[s] = 1, a && a();
              for(var e in c) d(e.split("|"), v) && !p(c[e], v) && (c[e] = [])
            }
          }
