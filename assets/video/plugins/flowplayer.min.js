!(function (e, t) {
  ...
  function c(e) {
    return "string" != typeof e
      ? e
      : "false" != e && ("true" == e || (isNaN(Number(e)) ? !!e : !!Number(e)));
  }
  var f = Object.freeze({
    __proto__: null,
    noop: t,
    ...
    get: function (e, t, n) {
      ...
      r.open("GET", e, !0),
        (r.onreadystatechange = function () {
          const e = r.status;
          e >= 400 && n && n(e),
            200 == e && 4 == r.readyState && t(r.responseText);
        }),
        r.send();
    },
    zero_pad: u,
  ...
  function y(e, t, n) {
    ...
    if (
      ...
      n || (n = []),
      n && !v(n) && (n = [n]),
      n.length && n.filter((e) => !!e).forEach((e) => r.append(e)),
      "object" != typeof t)
    )
      return r;
  ...
  function E(e) {
    return void 0 === e ||
      ...
      : (function (e) {
          ...
          return (
            (e.append = n.bind(e, "beforeend")),
            (e.prepend = n.bind(e, "afterbegin")),
            (e.css = function (t, n) {
              if ("object" == typeof t) {
              ...
              return void 0 === n && "string" == typeof t
                ...
                : ("number" == typeof n && (n += "px"), (e.style[t] = n), e);
            }),
            (e.show = function () {
              return e.css({
  ...
  function b(e, t) {
    ...
    var n =
      (t instanceof HTMLElement && t.querySelector(".fp-" + e)) ||
  ...
  b.window &&
    b.window.on(["load", "resize"], function () {
      k.forEach(function (e) {
        var t = e.root;
        t.prevWidth != t.clientWidth &&
          (e.emit("resize"), (t.prevWidth = t.clientWidth));
      });
    });
  ...
  function B(e) {
    ...
    return (
      e.in_viewport === t ||
        ((e.in_viewport = t), e.emit(t ? "viewenter" : "viewleave")),
      e
    );
  }
  b.window &&
  ...
  var K = [
    function (e, t, n) {
      var r = !0;
      t.addClass("flowplayer"),
        W(0, t),
        n.on(["loadstart", "resize"], function () {
          W(0, t);
        }),
        ...
        n.on(z, function () {
          var r =
            n.paused &&
            (!e.autoplay || t.hasClass("no-autoplay")) &&
            0 == n.currentTime;
          ...
          setTimeout(function () {
            t.defaultPrevented ||
              (e.rewind &&
                ...
                (e.autoplay &&
                  ((e.autoplay = !1),
                  n.setState("is-autoplay", !1),
                  n.setState(M, !1)),
                n.setState(L, !0),
                n.one("seeked", function () {
                  n.setState(L, !1), n.pause(), n.setState(x, !0);
                }),
                (n.currentTime = 0)),
              n.one("timeupdate", function () {
        ...
        n.on(["seeking", "seeked"], function (e) {
          n.setState(L, "seeking" == e.type),
            n.setState(T, n.paused),
            n.setState(O, !n.paused);
        }),
        n.on("ended", function () {
          r = !0;
        }),
        ...
        n.on(["waiting", "canplay", "loadstart"], function (t) {
          if (
            !n.hasState(L) &&
            ("canplay" != t.type || e.autoplay || n.setState(R, !1),
            "loadstart" != t.type || "none" != n.opt("preload") || e.autoplay)
          ) {
            if ("loadstart" == t.type && e.autoplay)
              return n.one("playing", function () {
                n.setState(R, !1);
              });
            "waiting" == t.type &&
              [O, T, x].forEach(function (e) {
                n.setState(e, !1);
              }),
              n.setState("is-ended", !1);
            var r = ["waiting"];
        ...
        n.on(["playing", "pause"], function (t) {
          ...
          if (
            (o && (n.started = !0),
            !e.seamless && r && n.setState(M, !1),
            o && (r = !1),
            n.setState(R, !1).setState(x, !1),
            !i && !n.hasState(L))
          ) {
            r && n.setState(x, !1);
            var u = o ? O : T,
              s = o ? T : O;
            n.transitionState(u, s, a ? 0 : 300),
              o && n.setState("no-autoplay", !1);
          }
        });
    },
    function (e, t, n) {
      ...
      (r.set = function (e) {
        (e = (function (e) {
          ...
          r.css("padding-top", isNaN(e) ? e : 100 * e + "%");
      }),
        t.reaper.put("aspect_ratio", r),
        t.append(r);
      var o = [j, F];
      n.on(o, function () {
        r.set(
          e.ratio ||
            (n.videoHeight && n.videoWidth && n.videoHeight / n.videoWidth)
        );
      }),
        n.on(z, function (e) {
          r.set(
      ...
      return (
        ...
        (t.run = function (n) {
          ...
          for (var r = t.props.map(X).sort(Q); r.length; ) {
            var o = r.shift(),
              u = i(e, o);
            u && u.reaper && !~n.indexOf(u.reaper) && u.reaper.run(n),
              a(e, o, 0);
          }
  ...
  (se.of = se),
    ...
    (se.maybe = function (e, t, n) {
      return e
        ? se._apply(t, [e].concat(ue.call(arguments, 2, arguments.length)))
        : e;
    }),
    (se.curry = function (e, t, n) {
      return (t = t || []).length > e.length - 1
        ? e.apply(n, t)
        : function () {
  ...
  var ce = new (function () {
    oe.call(this),
      (this.render = se.curry(le, [this, "onrender"])),
      (this.remove = se.curry(le, [this, "onremove"]));
  })();
  ...
  function pe(e) {
    e.setState("is-autoplay", !1),
      e.setState(R, !1),
      e.setState(M, !1),
      e.setState(T, !0),
      e.setState("no-autoplay", !0),
      0 == e.currentTime && e.setState(x, !0);
  }
  ...
  function he(e, t, n) {
    ...
    if (
      ("boolean" != typeof n && (n = e.paused),
      !(function (e, t, n) {
        var r = e.emit(
          t ? "beforeplay" : "beforepause",
          {
            forced: n
          },
          {
      ...
      try {
        ...
        (function (e) {
          return (
            (0 == e.networkState || 0 == e.readyState) &&
            e.currentSrc == _e(e.original_src)
          );
        })(e) && ge(e),
          fe(t) && ((e.muted = !1), 0 == e.volume && (e.volume = 1));
        var i = e.play();
        if (
          (i && (i.src = _e(e.original_src)), i && "function" == typeof i.catch)
        )
          return ve(i, e, t);
      ...
      return "string" == typeof e
        ...
        ? e.reduce(function (e, t) {
            return (
              ...
              "object" != typeof t || Array.isArray(t) || (t = Se(t)),
              e.concat(t)
            );
          }, [])
        : Se(e);
    })(n)),
      e.currentSrc && (e.innerHTML = "");
  ...
  function Ne(
    ...
    return (
      ...
      t.start_time && (n.src = n.src + "#t=" + t.start_time),
      "" == e.canPlayType(n.type || "")
        ? Ae.Err
        : !n.drm || (n.drm["com.apple.fps.1_0"] && r.safari)
        ? ("string" == typeof n.src && (e.src = n.src), Ae.Ok)
        : Ae.Err
    );
  }
  !(function (e) {
  ...
  function Re(e, t, n) {
    return isNaN(e.duration) || isNaN(e.currentTime)
      ? {}
      : ((t.offset += n),
        0 == t.offset
          ? Me(e, t)
          : (t.timer && clearTimeout(t.timer),
            (t.timer = setTimeout(function () {
              0 != e.reaper &&
                ((e.currentTime = (function (e, t, n = 0) {
                  return Math.max(Math.min(t, e), n);
                })(e.currentTime + t.offset, e.duration)),
                (t.timer = 0),
                Me(e, t));
            }, 1e3)),
            (function (e, t) {
              e.setState("will-seek", !0),
                e.setState(Le.BACKWARD, t.offset < 0),
                e.setState(Le.FORWARD, t.offset > 0);
            })(e, t),
            e.emit("seek:queued", t),
            t));
  }
  ...
  function Me(e, t) {
    t.timer && clearTimeout(t.timer),
      (t.timer = t.offset = 0),
      (function (e) {
        e.setState(Le.FORWARD, !1),
          e.setState(Le.BACKWARD, !1),
          e.setState("will-seek", !1);
      })(e);
  }
  !(function (e) {
  ...
  function Fe(e, t, o) {
    (o.toJSON = function () {
      ...
      (o.playerState = o.playerState || {}),
      (o.setState = function (e, t) {
        var n = {};
        return (
          (n[e] = t),
          (n = r({}, o.playerState, n))[R] && (n[O] = !1),
          (o.playerState = n),
          o.emit("state", o.playerState)
        );
      }),
      ...
      (o.render = function (e, t) {
        return "string" == typeof e
          ? ce.render(e, t)
          : (o.emit(D().ios ? F : j), o.emit("canplay"), o);
      }),
      (o.togglePlay = function (t, n) {
        var r = he(o, e, t);
        return "function" != typeof n
          ? r
          : r && "object" == typeof r && "catch" in r
          ? r.then(n)
          : n();
      }),
      (o.toggleMute = function (e) {
        (e = null == e ? !o.muted : !!e),
          (o.muted = e),
          o.muted || o.volume || (o.volume = 1),
          o.emit("volumechange");
      }),
      (o.toggleDisable = function (e) {
        (e = null == e ? !o.disabled : !!e),
          o.setState("is-disabled", e),
          (o.disabled = e);
      }),
      ...
      (o.setOpts = function (r) {
        if (0 != o.reaper) {
          ...
          "disabled" in r && o.toggleDisable(r.disabled),
            "muted" in r && o.toggleMute(r.muted),
            o.setState("is-autoplay", i),
            o.setState(
              "is-rtl",
              o.opt(
                "rtl",
            ...
            o.setState("is-live", !!e.live),
            o.setState("no-timeline", !(!e.live || e.dvr)),
            o.setState(M, !(!e.seamless && !i)),
            o.setState(
              "has-poster",
              "string" == typeof e.poster && e.poster.length > 0
            ),
            o.setState("is-seekable", !!e.seekable),
            (t.style.backgroundImage = o.hasState("has-poster")
              ? "url('" + e.poster + "')"
              : ""),
            o.emit(z, e);
        }
    ...
    (u = s),
      ...
      (o.enqueueSeek = function (e) {
        if (0 != o.opts.seekable && !(1 == o.opts.disabled && e > 0))
          return Re(o, s, e);
      });
  }
  ...
  function je(e, t) {
    var n = t.querySelector("video"),
      r = b(
        n ||
          (e._video_element_callback
            ? e._video_element_callback(e)
            : document.createElement("video"))
      );
    return (
      r.addClass("fp-engine"),
      J(r),
      (r.async = void 0 !== n),
      r.async && !r.paused
        ? (r.setState(O, !0).setState(M, !0), r)
        : (r.attr("playsinline", ""),
  ...
  function qe(e, t) {
    ...
    return "function" == typeof n
      ? (n(t), t)
      : (Array.isArray(n.extensions) || (n.extensions = []),
        ~n.extensions.indexOf(t) || n.extensions.push(t),
        t);
  }
  ...
  function Ve(e, t) {
    ...
    (this.raw = e),
      (this.data = JSON.parse(n.c || "{}")),
      (this.exp = n.exp),
      t.require_valid_token && Ve.validate(this);
  }
  ...
  (Ge.check_whitelist = function (e) {
    ...
    (Ve.validate = function (e) {
      ...
      var t = window.location.hostname,
        n = Ge.bind(null, t);
      if (e.data.domain && e.data.domain.length && !e.data.domain.some(n))
  ...
  var rt = $e(function (e, t) {
      (t.__esModule = !0),
        (t.prepare_url = t.URL_PARAM = void 0),
        (t.URL_PARAM = /:([a-zA-Z_]+)/g),
        (t.prepare_url = function (e, n) {
  ...
  function ht(e, t, n) {
    ...
    var r = this;
    return (
      (r.name = e.name || "RL::anonymous::" + Date.now()),
      (r.locked = !1),
      (r.ttl = t),
      (r.unlock = function () {
        return (r.locked = !1), r;
  ...
  function gt(e, t, n) {
    ...
    var o = this;
    (o.last_idx = 0),
      (o.segment_duration = 0),
      (o.breakpoints = []),
      (o.calculate_segment_info = function () {
        return (
          t.duration / 1 === t.duration && r(o, gt.segment_info(t.duration))
        );
      }),
      (o.run = function (e) {
  ...
  (gt.segment_info = function (e) {
    ...
    (gt.select_watched_segments = function (e, t, n) {
      ...
      return (
        ...
        o <= r
          ? []
          : e.breakpoints.slice(r, 99 == o ? 100 : o).map(function (t) {
  ...
  function _t(e, t, n) {
    ...
    var r = this;
    (r.last_tracked_ts = Date.now()),
      (r.ticks = 0),
      (r.run = function () {
        var e = Date.now();
        e - r.last_tracked_ts < 6e4 ||
          ((r.last_tracked_ts = e),
          ++r.ticks,
          t.emit(st, {
            position: 60 * r.ticks
  ...
  function wt(e) {
    ...
    return (
      void 0 !== t &&
      void 0 !== t.schedule &&
      "function" == typeof t.hasPreroll &&
      (t.currentRequests
        ? t.currentRequests
        : !!t.adPlaying || !(!t.hasPreroll() || 0 != t.nextIndex))
    );
  }
  ...
  var St = qe(ze(), function (e, t, n) {
    if (
      Xe.from_token(e.token).is_granted(Xe.permissions.ANALYTICS) &&
      !n.analytics
    ) {
      var r = (n.analytics = {
          ticker: void 0,
        ...
        a = (n.analytics.tracker = ut.Tracker.of(n, {
          ...
          url:
            "https://ptm.flowplayer.com/:video_type/:sitegroup_id/:event_type",
          events: bt,
          required_keys: pt,
            ...
            if (o.media_id) {
              ...
              if (!u || o.media_id != u) {
                ...
                a.put({
                  ...
                  (r.ticker = e.live ? _t(r, n, a) : gt(r, n, a)),
                  (r.ended = !1),
                  n.emit(lt);
              }
            }
      ...
      n.on("playing", function () {
        if (
          ...
          !(function (e, t) {
            return (
              e.metadata.media_id && e.metadata.media_id == t.last_media_id
            );
          })(a, r)
        ) {
          a.put({
          ...
          if (e)
            return (u = (function (e, t, n) {
              ...
              e,
              function () {
                (r.last_media_id = a.metadata.media_id),
                  n.emit(ct),
                  (u = void 0);
              },
              function () {
  ...
  function Ot(e, t, n) {
    ...
    "undefined" != typeof window &&
      ...
      n.setState("is-touch-device", !0),
      n.setState("is-accessibility", !1),
      t.middle.on("touchend", function (e) {
      ...
      n.on("touchend", function (e) {
        setTimeout(function () {
          if (!e.defaultPrevented && !n.hasClass(R)) {
            ...
            var t = n.hasState(x);
            r && clearTimeout(r),
              ((t || n.hasState(C) || n.hasState("no-autoplay")) &&
                (n.hasState(C) &&
                  (n.setState(C, !1), n.setState("is-hovered", !1)),
                n.togglePlay(),
                t)) ||
                (n.setState(C, !0),
                n.paused ||
  ...
  function Nt(e, n) {
    ...
    function p(t) {
      ...
      var i =
        ((function (e) {
          return (
            "function" == typeof window.TouchEvent && e instanceof TouchEvent
          );
        })(t)
    ...
    function v(e) {
      if (e) {
        var t = "";
        return (
          Array.prototype.forEach.call(e.classList, function (e) {
            t = "." + e;
          }),
          t
        );
    ...
    return (
      e.on("touchstart", function (t) {
        t.target.closest(v(e)) &&
          ((e.touching = !0),
          h(e.parentElement) &&
            (t.preventDefault(), (e.grabbing = !0), c(d, e), u(d, e), m(t)));
      }),
      e.on("touchmove", function (t) {
        t.target.closest(v(e)) &&
          h(e.parentElement) &&
          e.touching &&
          (t.preventDefault(), m(t), l.call(d, p(t), e));
      }),
      ...
      Tt.on("mouseup", function (t) {
        e.touching ||
          (Tt.off("mousemove", m),
          e.grabbing && ((e.grabbing = !1), s.call(d, e, p(t)), (o = 0)));
      }),
      e
    );
  }
  ...
  var xt = new (function () {
    ...
    (this.removeItem = n("removeItem")),
      (this.getItem = n("getItem", null)),
      (this.setItem = n("setItem"));
  })();
  ...
  function Rt(e) {
    var t,
      ...
      r = Lt("svg");
    return (
      r.setAttribute("viewBox", e.coords),
      e.name && r.setAttribute("class", e.name),
      e.title && r.setAttribute("title", e.title),
      e.title && r.setAttribute("aria-label", e.title),
      r.setAttribute("tabindex", "0"),
      r.setAttribute("focusable", "true"),
      r.appendChild(
        ((t = e.link),
        (n = Lt("use")).setAttributeNS(
  ...
  function Bt(e, t, n) {
    if (n.opt("controls")) {
      ...
      if (
        ...
        0.1 == Wt.volume && t.append(r),
        r
          .attr("tabindex", "0")
          .attr("role", "slider")
          .attr("aria-valuemin", "0")
          .attr("aria-valuemax", "1")
          .attr("aria-label", n._t("core.volume", "volume")),
        e.muted_initially && xt.setItem("mute", 1 == e.muted_initially),
        n.on("volumechange", function () {
          var e = 0 == n.volume || n.muted;
          if (
            (n.setState("is-muted", e),
            xt.setItem("mute", e),
            i.attr(
              "aria-label",
              e ? n._t("unmute", "unmute") : n._t("mute", "mute")
            ),
            e)
          )
            return o.adjust(0);
        ...
        "true" == xt.getItem("mute") &&
          ((n.muted = !0), n.setState("is-muted", n.muted)),
        e.muted_initially)
      )
        return (
          (n.volume = 0),
          n.one("pause", function () {
      ...
      return (
        a && !isNaN(a) && (n.volume = Number(a)), n.emit("volumechange"), o
      );
    }
  }

  function Kt(e, t) {
    e > 0 && ((this.muted = !1), xt.removeItem("mute")),
      xt.setItem("volume", (this.volume = e / 100)),
      t.adjust(this.volume);
  }
  ...
  function Yt(e, t, n, r) {
    ...
    return (
      e.empty(),
      r.hasClass("is-small") && (o = 8),
      r.hasClass("is-tiny") && (o = 6),
      Nt(e, {
        onseek: t,
        ctx: this
      }),
  ...
  function Jt(e, t, n) {
    (n.toggleFullScreen = function (r, o) {
      n.ios_fullscreen_disabled ||
        ("boolean" != typeof r && (r = !n.in_fullscreen),
        r != n.in_fullscreen &&
          ((n.in_fullscreen = r),
          n.emit(r ? "fullscreenenter" : "fullscreenexit"),
          n.emit("resize"),
          b.document.fullscreenEnabled &&
            !e.fake_fullscreen &&
            (r ? t.requestFullScreen() : b.document.exitFullScreen()),
          Zt() &&
            (n.in_fullscreen
              ? (function (e) {
                  e.getAttribute("playsinline") &&
                    e.removeAttribute("playsinline");
                  e.getAttribute("webkit-playsinline") &&
                    e.removeAttribute("webkit-playsinline");
      ...
      Zt() &&
        ((n.ios_fullscreen_disabled = !0),
        n.one("beforeplay", function () {
      ...
      n.on(["fullscreenexit", "fullscreenenter"], function (e) {
  ...
  function $t(e, t, n) {
    var r = b.div("fp-header"),
      ...
      u = (function (e, t) {
        ...
        var r = Rt(Mt)
            .attr("role", "button")
            .attr("aria-label", t._t("core.fullscreen")),
          o = Rt(Ct)
            .attr("role", "button")
            .attr("aria-label", t._t("core.fullscreen_exit"));
        return (
          r.on(U, t.toggleFullScreen),
          o.on(U, t.toggleFullScreen),
          n.append([r, o]),
          n
        );
      })(e, n),
    ...
    n.on(z, function (e) {
      ...
      r.append([o, a, u]),
      t.append(r),
      t.reaper.put("header", r),
      t.reaper.put("header.secondary", u);
  }
  (Bt.inject_bar = Yt),
    (Bt.Tick = Xt),
    (Xt.on = function (e) {
    ...
    (function () {
      ...
      if (e) {
        ...
        t.requestFullScreen ||
          ["webkit", "moz", "ms"].forEach(function (n) {
            var r = t[n + "RequestFullScreen"] || t.msRequestFullscreen,
              o = e[n + "CancelFullScreen"] || e.msExitFullscreen;
            r && ((t.requestFullScreen = r), (e.fullscreenEnabled = !0)),
              o && (e.exitFullScreen = o);
          }),
            ...
            var t,
              n =
                !1 !==
                  (function () {
                    try {
                      if ("boolean" == typeof document.fullscreen)
                        return document.fullscreen;
                      if ("boolean" == typeof document.mozFullScreen)
                        return document.mozFullScreen;
                      if ("boolean" == typeof document.webkitIsFullScreen)
                        return document.webkitIsFullScreen;
                      if ("boolean" == typeof document.msFullscreenElement)
  ...
  function tn(e, t, n) {
    ...
    return (
        ...
        e.on("seeked", function () {
          ...
          e.on("seek:queued", function (e) {
            ...
            if ("number" == typeof o.offset) {
              ...
              return (
                rn(u == r ? n : r),
                (a = i),
                void (u.querySelector(".fp-zone-seconds").innerText = Math.abs(
                  a
                ))
              );
            }
          ...
          t.forEach(function (t) {
            var r = t == n ? -1 : 1,
              ...
              a = nn(Pt).cloneNode(!0);
            a.setAttribute("class", "fp-fast-forward"),
              i.append([a.cloneNode(!0), a.cloneNode(!0)]),
              t.append([o, i]),
              rn(t),
              t.on("touchend", function (t) {
                isNaN(e.duration) ||
                  isNaN(e.currentTime) ||
                  16384 & e.opts.ui ||
                  e.hasState("no-timeline") ||
                  (!e.hasState("will-seek") && !e.hasState(C)) ||
                  (e.enqueueSeek(5 * r) &&
      ...
      (function (e, t) {
        e.on([U, "dblclick"], function (e) {
          if (!e.defaultPrevented)
            return e.preventDefault(), t.emit(e.type, e.data), !1;
        }),
          t.on(U, function (e) {
            setTimeout(function () {
      ...
      e.mouseover_play &&
        n.root.on(["mouseenter", "mouseleave"], function (e) {
          n.togglePlay("mouseenter" == e.type);
        }),
      en.forEach(function (e) {
        i.append(
          b
            .div("fp-switch", [Gt["PLAY_" + e], Gt["PAUSE_" + e]].map(nn))
            .addClass("fp-play-" + e)
        );
      }),
      t.append(r),
      r.attr("tabindex", 0),
      r.attr("role", "button"),
      r.attr("aria-label", n._t("core.play")),
      n.once(["playing", "seeked"], function () {
  ...
  function fn(e, t) {
    ...
    o
      .attr("role", "slider")
      .attr("tabindex", "0")
      .attr("aria-label", t.translate("timeline", "Timeline")),
      o.append([c, f, d, p]),
      n.append([i, a, v, o, m]),
      a.append([u, l]),
      J(n);
  ...
  var pn = Object.freeze({
    ...
    buffer_update: function (e, t, n) {
      if (!isNaN(t.duration)) {
        ...
        r.length &&
          n.buffer.css(
            "width",
            Math.min((r.end(0) / t.duration) * 100, 100) + "%"
          );
      }
    },
    ...
    tooltip_update: function (e, t, n) {
      ...
      !o ||
        ...
        isNaN(t.duration) ||
        (dn(n.timestamp, r),
        o.empty().append(b.span().txt(s((r / 100) * t.duration))));
    }
  });

  function mn(e) {
    if ("object" != typeof e.opts)
      return {
        head: 0,
        tail: 0
      };
    if (e.opts.live_seekable_range) return e.opts.live_seekable_range;
    if (0 == e.seekable.length)
      return {
        head: 0,
        tail: 0
      };
  ...
  function gn(e) {
    ...
    return "number" == typeof t
      ...
      : (function (e) {
          ...
          (function (e) {
            return e.opts.live_rebuffer_budget || 0.5;
          })(e);
  }
  ...
  function _n(e, t) {
    if (t > 1 || t < 0)
      return (
        console.warn("cannot calculate a percent outside of range(0..1)"), 0
      );
  ...
  var yn = Object.freeze({
    ...
    seek_to_now: function (e, t, n) {
      try {
        ...
        var r = gn(t);
        (t.currentTime = r),
          t.setState("is-live-seeked", !1),
          n.progress.css("width", 0);
      } catch (e) {
  ...
  function bn(e, t, n) {
    if (n.opt("controls")) {
      ...
      var a = En([n, r]);
      n.reaper.put("_behavior", a),
        [].forEach.call(r.btns.childNodes, function (e) {
          e.on(U, n.togglePlay);
        }),
        ...
        n.on(z, function (t) {
          if (0 != n.reaper) {
            ...
            if (
              (void 0 === i(t, "data.seekable") && (e.seekable = !0),
              isNaN(o) || o >= Number.MAX_SAFE_INTEGER)
            )
              return r.duration.hide();
      ...
      n.on("playing", m),
        ...
        n.on("timeupdate", function (t) {
          if (0 != n.reaper) {
            var r = wn(e);
            o.attr("aria-valuenow", n.currentTime),
              a.route(r, t),
              a.route(r, {
                type: "buffer_update"
              }),
        ...
        n.on("durationchange", function (e) {
          if (0 != n.reaper) {
            ...
            0 == n.reaper ||
              ...
              o.attr("aria-valuemax", r),
              o.attr("aria-valuemin", "0"));
          }
        }),
  ...
  function kn(e, t) {
    return function () {
      0 != i(e, "opts.seekable", !0) &&
        (isNaN(e.duration) || t.apply(null, arguments));
    };
  }
  var Sn = {
  ...
  function Nn(e, t, n) {
    ...
    J(o),
      r.appendChild(o),
      t.reaper.put("ui", o),
      ~t.className.indexOf("use-play-") ||
        t.addClass("use-play-" + (e.play || 1)),
      (function (e, t, n) {
        var r = t.append(
          b.div({
            class: "fp-footer"
          ...
          if (
            ...
            var i = n.split(" "),
              a = b
                ...
                .txt(i.join(" "));
            for (r.append(a); i.length > 1 && a.scrollHeight > a.offsetHeight; )
              i.pop(), a.txt(i.join(" ") + "...");
          }
        });
      })(0, t, n),
      ...
      t.on(["mouseenter", "mouseleave"], function (e) {
        n.setState("is-hovered", "mouseenter" == e.type),
          n.setState("is-accessibility", !1);
      }),
      n.on(z, function (e) {
        var n = i(e, "data.ui", {});
        "number" == typeof n &&
          (t.toggleClass("use-play-1", !(32 & n || 64 & n)),
          t.toggleClass("use-play-2", 32 & n),
          t.toggleClass("use-play-3", 64 & n),
          t.toggleClass("use-thin-controlbar", 128 & n),
          t.toggleClass("no-title", 256 & n),
          t.toggleClass("no-description", 512 & n),
          t.toggleClass("logo-on-right", 8 & n),
          t.toggleClass("use-drag-handle", 16 & n),
          t.toggleClass("no-controls", 1024 & n),
          t.toggleClass("no-duration", 2048 & n),
          t.toggleClass("no-header", 4096 & n),
          t.toggleClass("no-mute", 4 & n),
          t.toggleClass("no-volume", 2 & n),
          t.toggleClass("no-fullscreen", 1 & n),
          t.toggleClass("no-touch-zones", 16384 & n));
      });
    var a = !1;
    o.on("mousemove", function () {
      "number" == typeof a && clearTimeout(a),
        n.setState("is-hovered", !0),
        (a =
          0 == n.paused &&
          setTimeout(function () {
  ...
  function xn(e, t) {
    var n = {
      ...
      o = JSON.stringify(n),
      i =
        "undefined" != typeof flowplayer && flowplayer.METERING_URL
          ? flowplayer.METERING_URL
          : "https://pmi.flowplayer.com/in";
    r.open("POST", i, !0),
      (r.timeout = 2500),
      r.send(o),
      r.addEventListener("load", t.bind(null, r));
  }
        ...
        (function (e, t) {
          ...
          (function () {
            try {
              return Mn.apply(
                [],
                (navigator.languages || [navigator.language]).map(function (e) {
  ...
  var Pn = Date.now(),
    In = {
      session_id:
        Math.random().toString(36).substring(2) + performance.now().toString(36)
    };
  class Dn {
    constructor() {
  ...
  function Un(e, t) {
    return (function (e, t) {
      return (
        "function" == typeof navigator.sendBeacon && navigator.sendBeacon(e, t)
      );
    })(
      e,
      JSON.stringify({
  ...
  class Fn {
    ...
    _run_middleware(e, t) {
      return (
        (e = r({}, e)),
        this.middleware.forEach(function (n) {
          var o = n(t);
          if ("object" == typeof o) return r(e, o);
          console.warn(
            "KPI::middleware did not return an Object\nreturn: %o\n\nfn: %s",
            o,
            n
          );
        }),
    ...
    send(e) {
      if (!(this._pending.length < 20) || e) {
        ...
        (this._pending.length = 0),
          Un("https://health.flowplayer.com/v1/health/events", t);
      }
    }
  }
  ...
  function qn(e) {
    ...
    return n ? 0.001 * n.getEstimate() : void 0;
  }
    ...
    if (!n._health) {
        ...
        (function (e) {
          (Qn = !0),
            window.addEventListener("unload", function () {
              e &&
                "function" == typeof e &&
                Array.isArray(e.instances) &&
                e.instances.forEach((e) => e.emit("unload"));
            });
        })(this);
      ...
      Yn.forEach((e) => {
        ...
        n.on(Yn, function (e) {
          setTimeout(() => {
            e.defaultPrevented ||
              n.emit("health:summary:increment", {
                [e.type]: 1
              });
          });
        }),
  ...
  !(function (e) {
    if ("undefined" == typeof document || ~Ce.indexOf(document.readyState))
      return e();
