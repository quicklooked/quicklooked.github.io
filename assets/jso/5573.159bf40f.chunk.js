		...
		59792: function(t) {
			t.exports = function(t) {
					...
					r = function() {
						...
						return n(t, [{
							...
							value: function(t, e, n) {
								...
								i.open("POST", o), i.setRequestHeader("LightStep-Access-Token", t.access_token), i.setRequestHeader("Content-Type", "application/json"), i.onreadystatechange = function() {
							...
							value: function(t, e, n) {
								var r = JSON.stringify(t),
									o = JSON.stringify(e),
									i = ("none" === this._encryption ? "http" : "https") + "://" + this._host + ":" + this._port + this._path + "/_rpc/v1/reports/uri_encoded?auth=" + encodeURIComponent(r) + "&report=" + encodeURIComponent(o),
					...
					c = function(t) {
						...
						return function(t, e) {
							...
							value: function(t, e) {
								var n = this;
								if("object" == typeof t) {
									var r = e ? 1e3 * e : n._tracerImp._platform.nowMicros(),
										o = [];
									...
									n._log_records = n._log_records || [], n._log_records.push(s), n._tracerImp.emit("log_added", s)
							...
							value: function() {
								var t = [];
								return (0, a.default)(this._tags, (function(e, n) {
									t.push(new l.crouton_thrift.KeyValue({
										Key: i.toString(n),
										Value: i.toString(e)
									}))
				...
				var o = function() {
					...
					w = function(t) {
						function e(t) {
							...
							r._delegateEventEmitterMethods(), t = t || {}, b || (h.setOptions(t), b = r), r._platform = new c.Platform(r), r._runtimeGUID = t.guid || r.override_runtime_guid || null, r._plugins = {}, r._options = {}, r._optionDescs = [], r._makeOptionsTable(), r._opentracing = s, t.opentracing_module && (r._opentracing = t.opentracing_module);
							...
							return r._transport = (t ? t.override_transport : null) || new c.Transport(i), r._reportingLoopActive = !1, r._reportYoungestMicros = o, r._reportTimer = null, r._reportErrorStreak = 0, r._lastVisibleErrorMillis = 0, r._skippedVisibleErrors = 0, r._activeRootSpanSet = {}, r._activeRootSpan = null, r._useClockState = !0, r._clockState = new p({
								nowMicros: function() {
						...
						return function(t, e) {
							...
							value: function() {
								var t = this;
								this._ee = new i.default, (0, l.default)(["addListener", "emit", "eventNames", "getMaxListeners", "listenerCount", "listeners", "on", "once", "prependListener", "prependOnceListener", "removeAllListeners", "removeListener", "setMaxListeners"], (function(e) {
									t[e] = function() {
							...
							value: function(t, e) {
								...
								if((e = e || {}).references)
									for(var o = 0; o < e.references.length; o++) {
										...
										if(s === this._opentracing.REFERENCE_CHILD_OF || s === this._opentracing.REFERENCE_FOLLOWS_FROM) {
											...
											if(!c) {
												this._error("Span reference has an invalid context", c);
												continue
											}
											r = c;
											break
								...
								var p = r ? r._traceGUID : this.generateTraceGUIDForRootSpan(),
									_ = new u.default(this, t, new a.default(this._platform.generateUUID(), p));
								return _.addTags(this._options.default_span_tags), (0, l.default)(e, (function(t, e) {
									switch(e) {
										case "references":
											break;
										case "startTime":
								...
								})), null !== r && _.setParentGUID(r._guid), this.emit("start_span", _), _
							}
						}, {
							key: "_inject",
							value: function(t, e, n) {
							...
							value: function(t, e) {
								return e ? "object" != typeof e ? void this._error("Unexpected '" + typeof e + "' FORMAT_TEXT_MAP carrier in call to inject") : (e[m + "spanid"] = t._guid, e[m + "traceid"] = t._traceGUID, t.forEachBaggageItem((function(t, n) {
									e["" + y + t] = n
								})), e[m + "sampled"] = "true", e) : void this._error("Unexpected null FORMAT_TEXT_MAP carrier in call to inject")
							}
						}, {
							key: "_extract",
							value: function(t, e) {
							...
							value: function(t, e) {
								var n = this,
									...
									o = 0;
								return (0, l.default)(e, (function(t, e) {
									if((e = e.toLowerCase()).substr(0, m.length) === m) switch(e.substr(m.length)) {
										case "traceid":
											o++, r._traceGUID = t;
											break;
										case "spanid":
								...
								})), 0 === o ? null : o < 2 ? (this._error("Only found a partial SpanContext: " + t + ", " + e), null) : ((0, l.default)(e, (function(t, e) {
									if((e = e.toLowerCase()).substr(0, y.length) === y) {
							...
							value: function(t) {
								...
								var n = {},
									r = {};
								for(var o in (0, l.default)(this._optionDescs, (function(o) {
							...
							value: function(t) {
								...
								if(null === this._thriftAuth) this._options.access_token.length > 0 && this._options.component_name.length > 0 && function() {
									e._runtimeGUID = e._platform.runtimeGUID(e._options.component_name), e._thriftAuth = new c.crouton_thrift.Auth({
									...
									(0, l.default)(t, (function(t, e) {
										r.push(new c.crouton_thrift.KeyValue({
											Key: f.toString(e),
											Value: f.toString(t)
										}))
							...
							value: function(t) {
								...
								if(!this._reportTimer) {
									...
									0 === this._reportErrorStreak && this._useClockState && !this._clockState.isReady() && (n = Math.min(d.CLOCK_STATE_REFRESH_INTERVAL_MS, n));
									var r = (1 + Math.min(7, Math.max(0, this._reportErrorStreak))) * n,
										o = .5 * Math.random() - .25 + 1,
										i = Math.floor(Math.max(0, o * r));
									this._debug("Delaying next flush for " + i + "ms"), this._reportTimer = g.detachedTimeout((function() {
							...
							value: function(t, e, n) {
								...
								this._transport.ensureConnection(this._options), console.assert(null !== this._runtimeGUID, "No runtime GUID for Tracer"), (0, l.default)(s, (function(t) {
									t.runtime_guid = r._runtimeGUID
								}));
								var p = [];
								(0, l.default)(a, (function(t, e) {
									0 !== t && p.push(new c.crouton_thrift.MetricsSample({
										name: f.toString(e),
								...
								this._transport.report(e, this._thriftAuth, h, (function(t, o) {
									...
									if(t) {
										...
										}), r._restoreRecords(h.span_records, h.internal_logs, h.counters), r._counters["reports.errors.send"]++, r.emit("report_error", t, {
											error: t,
							...
							value: function(t, e) {
								...
								var n = this.log().level(d.LOG_ERROR).message(t).payload(e).record();
								...
								if(0 !== r) {
									...
									if(1 === r) {
										...
										if(this._skippedVisibleErrors > 0) {
											...
											this._printToConsole("error", "[LightStep:ERROR] " + i, e)
										}
									}
						...
						return r(t, [{
							...
							value: function(t, e, n, r) {
								var o = Number.MAX_VALUE,
									i = 0;
								t > 0 && e > 0 && n > 0 && r > 0 && (o = r - t - (n - e), i = (e - t + (n - r)) / 2), 8 === this._samples.length && this._samples.shift(), this._samples.push({
									delayMicros: o,
									offsetMicros: i
							...
							value: function() {
								var t = Number.MAX_VALUE,
									e = 0;
								if((0, o.default)(this._samples, (function(n) {
									...
									(this._currentOffsetAge > 7 || Math.abs(this._currentOffsetMicros - e) < 3 * n) && (this._currentOffsetMicros = e, this._currentOffsetAge = 0)
								}
							}
						}, {
							key: "offsetMicros",
					...
					i = function() {
						...
						return r(t, [{
							...
							value: function(t, e) {
								var n = this;
								if(t) {
									if(t.setTag("user_agent", navigator.userAgent), (0, o.default)(e, (function(e, r) {
				...
				var i = function() {
					...
					u = {};
				"object" == typeof window && void 0 !== window.XMLHttpRequest && (u = {
					XMLHttpRequest,
				...
				var l = function() {
					...
					return i(t, [{
						...
						value: function() {
							return function(t, e) {
								return this.__requestHeaders = this.__requestHeaders || {}, this.__requestHeaders[t] = e, u.setRequestHeader.apply(this, arguments)
							}
						}
					}, {
						key: "_instrumentOpen",
						value: function() {
							...
							return function(n, i, a, l, c) {
								if(!t._shouldTrace(e, this, i)) return u.open.apply(this, arguments);
								var p = e.startSpan("XMLHttpRequest");
								e.addActiveRootSpan(p), this.__tracer_span = p, this.__tracer_url = i;
								var _ = {
									method: n,
									url: i,
									async: a,
						...
						value: function() {
							...
							return function() {
								var n = this;
								if(!t._shouldTrace(e, this, this.__tracer_url)) return u.send.apply(this, arguments);
								...
								var l = {};
								return e.inject(r.context(), a.FORMAT_HTTP_HEADERS, l), Object.keys(l).forEach((function(t) {
						...
						value: function(t, e, n) {
							...
							for(var o in this._internalExclusions)
								if(this._internalExclusions.hasOwnProperty(o) && this._internalExclusions[o].test(n)) return !1;
							var i = !1;
							for(var s in r.xhr_url_inclusion_patterns)
								if(r.xhr_url_inclusion_patterns.hasOwnProperty(s) && r.xhr_url_inclusion_patterns[s].test(n)) {
									i = !0;
									break
								} if(!i) return !1;
							for(var a in r.xhr_url_exclusion_patterns)
								if(r.xhr_url_exclusion_patterns.hasOwnProperty(a) && r.xhr_url_exclusion_patterns[a].test(n)) return !1;
							return !0
						}
					}]), t
				}();
