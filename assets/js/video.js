! function(t, e) {
  ...
  var Ce = function e(r) {
    ...
    var o = function(t) {
      ...
      screenshot: '<svg xmlns="http://www.w3.org/2000/svg" height="22" width="22" viewBox="0 0 36 36">\t<path d="M7.5,22.5h-3v9h9v-3h-6V22.5z M7.5,7.5h6v-3h-9v9h3V7.5z M31.5,4.5h-9v3h6v6h3V4.5z M28.5,28.5h-6v3h9v-9h-3V28.5z M18,12  c-3.3,0-6,2.7-6,6s2.7,6,6,6s6-2.7,6-6S21.3,12,18,12z M18,21c-1.7,0-3-1.3-3-3s1.3-3,3-3s3,1.3,3,3S19.7,21,18,21z"/></svg>',
