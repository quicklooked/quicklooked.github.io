...
var buttonFrançais = document.querySelector("#buttonFrançais");
var buttonNone = document.querySelector("#buttonNone");
var vp_panel_stat_text_captions = document.querySelector("#vp-panel-stat-text-captions");
var vp_captions = document.querySelector(".vp-captions");
...
function transcript_size() {
  var cues_current = document.querySelector(".cues");
  for (var i = 0; len = cues_current.length; i < len; i++) {
    if (cues_current[i].classList.contains("current")) {
      vp_captions.classList.add("hidden");
    } else {
      vp_captions.classList.remove("hidden");
    }
  }
}

video.addEventListener("timeupdate", transcript_size, false);

function vp_captions_font_size() {
  if (player.clientWidth <= 680) {
    vp_captions.style.fontSize = "16px";
  } else if (player.clientWidth > 680 && player.clientWidth <= 1024) {
    vp_captions.style.fontSize = "20px";
  } else if (player.clientWidth > 1024 && player.clientWidth <= 1600) {
    vp_captions.style.fontSize = "24px";
  } else if (player.clientWidth > 1600) {
    vp_captions.style.fontSize = "32px";
  }
}

video.addEventListener("timeupdate", vp_captions_font_size, false);
...
function captions_with_control() {
  var vp_controls = document.querySelector(".vp-controls");
  if(vp_controls.classList.contains("invisible")) {
    vp_captions.classList.remove("with-controls");
  } else {
    vp_captions.classList.add("with-controls");
  }
}

function addEnglishCC() {
  buttonEnglish.classList.add("vp-panel-item-on");
  buttonFrançais.classList.remove("vp-panel-item-on");
  vp_panel_stat_text_captions.innerHTML = "English";
  buttonNone.classList.remove("vp-panel-item-on");
  toggLe.classList.remove("off");
  toggLe.classList.add("on");
  vp_captions.classList.remove("hidden");
  vp_captions.lang = "en";
  vp_captions.hidden = false;
}
function addFrançais() {
  buttonEnglish.classList.remove("vp-panel-item-on");
  buttonFrançais.classList.add("vp-panel-item-on");
  vp_panel_stat_text_captions.innerHTML = "Français";
  buttonNone.classList.remove("vp-panel-item-on");
  toggLe.classList.remove("off");
  toggLe.classList.add("on");
  vp_captions.classList.remove("hidden");
...
function addNone() {
  buttonEnglish.classList.remove("vp-panel-item-on");
  buttonFrançais.classList.remove("vp-panel-item-on");
  vp_panel_stat_text_captions.innerHTML = "None";
  buttonNone.classList.add("vp-panel-item-on");
  toggLe.classList.add("off");
  toggLe.classList.remove("on");
  vp_captions.classList.add("hidden");
  vp_captions.lang = "";
  vp_captions.hidden = true;
}
...
vp_outro_wrapper.addEventListener("click", videoplay, false);
...
video.addEventListener("timeupdate", captions_with_control, false);
buttonEnglish.addEventListener("click", addEnglishCC, false);
buttonFrançais.addEventListener("click", addFrançais, false);
buttonNone.addEventListener("click", addNone, false);

vp_outro_wrapper.addEventListener("mouseleave", mouseLeave, false);
vp_outro_wrapper.addEventListener("mousemove", resetDelay, false);
...
var buttonEnglish, buttonFrançais;
window.onload = function() {
  ...
  buttonFrançais = document.querySelector("#buttonFrançais");
  buttonEnglish.disabled = false;
  buttonFrançais.disabled = false;
