...
resetDelay = function() {
  ...
  inactivityTimeout = setTimeout(function() {
    ...
    player.classList.remove("player-cursor-hide");
  }, 10);
};
...
function hideCursor() {
  var playcus = document.querySelector(".player");
  if(playcus.classList.contains("only-in-fullscreen")) {
    playcus.classList.add("player-cursor-hide");
  } else {
    playcus.classList.remove("player-cursor-hide");
  }
}

vp_left_zone.addEventListener("mouseover", showCursor, false);
vp_left_zone.addEventListener("mouseout", hideCursor, false);
vp_right_zone.addEventListener("mouseover", showCursor, false);
vp_right_zone.addEventListener("mouseout", hideCursor, false);
vp_outro_wrapper.addEventListener("mouseover", hideCursor, false);
vp_outro_wrapper.addEventListener("mouseout", hideCursor, false);
