var videoquicklook = document.querySelector(".videoquicklook");
...
this.openFullscreen = function () {
  videoquicklook.classList.add("vp-center");
  if (videoquicklook.requestFullScreen) {
    videoquicklook.requestFullScreen();
  } else if (videoquicklook.mozRequestFullScreen) {
    videoquicklook.mozRequestFullScreen();
  } else if (videoquicklook.webkitRequestFullScreen) {
    videoquicklook.webkitRequestFullScreen();
  }
  this.fullscreen = true;
};

this.closeFullscreen = function () {
  videoquicklook.classList.remove("vp-center");
