...
function vp_captions_font_size() {
  if (video.clientWidth <= 680) {
    vp_captions.style.fontSize = "15px";
  } else if (video.clientWidth > 680 && video.clientWidth <= 1024) {
    vp_captions.style.fontSize = "24px";
  }
}

vp_captions.addEventListener("timeupdate", vp_captions_font_size, false);
