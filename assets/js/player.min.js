...
function chosseCC() {
  var vp_panel_item = document.getElementsByClassName("vp-panel-item").attributes;
  for(i = 0; i < vp_panel_item.length; i++) {
    if(vp_panel_item["aria-checked"].value = "false") {
      vp_panel_item[i].ariaChecked = "true";
      vp_panel_item[i].classList.add("vp-panel-item-on");
    }
    else {
      vp_panel_item[i].ariaChecked = "false";
      vp_panel_item[i].classList.remove("vp-panel-item-on");
    }
  }
}
