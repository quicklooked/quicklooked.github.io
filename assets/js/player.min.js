...
for(var i = 0; i < document.getElementsByClassName('vp-panel-item').length; i++) {
  ...
  d.onclick = function(e) {
    if((document.getElementsByClassName('vp-panel-item')[i].ariaChecked == "false")) {
      document.getElementsByClassName('vp-panel-item')[i].ariaChecked = "true";
      document.getElementsByClassName('vp-panel-item')[i].classList.add("vp-panel-item-on");
    } else {
      document.getElementsByClassName('vp-panel-item')[i].ariaChecked = "false";
      document.getElementsByClassName('vp-panel-item')[i].classList.remove("vp-panel-item-on");
    }
  }
}
