...
document.querySelector(".vp-left-zone").addEventListener('click', function() {
  vid_currentTimeLeft = video.currentTime;
  video.currentTime = vid_currentTimeLeft - 5;
});
document.querySelector(".vp-right-zone").addEventListener('click', function() {
  vid_currentTimeRight = video.currentTime;
  video.currentTime = vid_currentTimeRight + 5;
});
