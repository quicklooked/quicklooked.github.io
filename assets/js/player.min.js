var videoPlayerFullcreen = document.querySelector(".video-player-fullcreen");
...
this.openFullscreen = function () {
  videoPlayerFullcreen.classList.add("vp-center");
  player.style.maxWidth = "calc(177.778vh)";
  player.style.height = "calc(56.25vw)";
  if (videoPlayerFullcreen.requestFullScreen) {
    videoPlayerFullcreen.requestFullScreen();
  } else if (videoPlayerFullcreen.mozRequestFullScreen) {
    videoPlayerFullcreen.mozRequestFullScreen();
  } else if (videoPlayerFullcreen.webkitRequestFullScreen) {
    videoPlayerFullcreen.webkitRequestFullScreen();
  }
  this.fullscreen = true;
};

this.closeFullscreen = function () {
  videoPlayerFullcreen.classList.remove("vp-center");
