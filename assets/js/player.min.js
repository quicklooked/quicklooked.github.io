...
vp_left_zone.addEventListener("mousemove", showCursor, false);
vp_right_zone.addEventListener("mousemove", showCursor, false);
vp_outro_wrapper.addEventListener("mouseenter", hideCursor, false);
vp_outro_wrapper.addEventListener("mouseleave", hideCursor, false);
