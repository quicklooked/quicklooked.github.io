...
function videoended() {
  ...
  progressPlayedMinibar.width = "0%";
  progressLoadedMinibar.width = "0%";
...
function beginProgress(e) {
  ...
  progressLoadedMinibar.Width = `${(video.buffered.end(0) / video.duration) * 100}%`;
}
...
function updateProgress(e) {
  ...
  progressPlayedMinibar.width = (video.currentTime / video.duration) * 100 + "%";
}
