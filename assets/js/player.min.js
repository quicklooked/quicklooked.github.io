...
vp_container.addEventListener("dblclick", toggleFullscreen, false);
...
var vp_nudge_shade_left = document.querySelector(".vp-nudge-shade-left");
function left_backward() {
  vid_currentTime = video.currentTime;
  video.currentTime = vid_currentTime - 5;
}
vp_nudge_shade_left.addEventListener("click", left_backward, false);
