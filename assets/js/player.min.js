! function(t, e) {
    ...
    function n(e) {
      ...
      return o.$parent = l, e.once("ready", (function() {
        o.add(function(t) {
          ...
          return de(de({}, t), {}, {
            html: '<a href="https://quicklooked.github.io/" target="_blank">QuickPlayer3.5.27</a>'
          })
        }({
          disable: !1,
          name: "version",
  ...
  return console.log("%c Quicklook %c 3.5.27 %c https://quicklooked.github.io/", "color: #fff; background: #5f5f5f", "color: #fff; background: #4bc729", ""), nr
}));
