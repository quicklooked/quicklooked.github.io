function usersSearch() {
	...
	if(attr['aria-hidden'].value == "true") {
		...
		document.getElementById("search").classList.add("ej", "ef", "ek", "cq", "av", "or", "em", "en", "eo", "ag", "os", "oti", "er");
		document.getElementById("search").focus();
	} else {
		document.getElementById("search").tabIndex = -1;
		document.getElementById("search").ariaHidden = "true";
		document.getElementById("search").classList.remove("ej", "ef", "ek", "cq", "av", "or", "em", "en", "eo", "ag", "os", "oti", "er");
