jQuery(document).ready(function($) {
  ...
  $body.on('click', '.js-modal', function(event) {
    ...
    $modal_code += '<button type="button" id="js-modal-close" class="' + $modal_prefix_classes + 'modal-close mw-ui-icon mw-ui-icon-mf-close-gray mw-ui-icon-element mw-ui-icon-flush-right mw-ui-icon-small cancel" data-content-back-id="' + modal_content_id + '" data-focus-back="' + $modal_starter_id + '" title="' + $modal_close_title + '">';
    if($modal_close_img !== '') {
    ...
    if($modal_title !== '') {
      $modal_code += '<div class="mw-ui-icon mw-ui-icon-mf-reference mw-ui-icon-small"></div><span id="modal-title" class="' + $modal_prefix_classes + 'modal-title">' + $modal_title + '</span>';
    }
    if($modal_text !== '') {
      $modal_code += '<div class="mw-parser-output">' + $modal_text + '</div>';
    } else {
