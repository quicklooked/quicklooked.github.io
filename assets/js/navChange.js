function navChange() {
	...
	if(attr['aria-label'].value == "Expand navbar") {
		...
		document.getElementById("navchange2").d = "M12.6.59L7 6.19 1.39.6l-.8.8L6.19 7 .6 12.61l.8.8L7 7.81l5.61 5.6.8-.8L7.81 7l5.6-5.61";
		...
		document.getElementById("navchange2").d = "M0 .5h14M0 7h14M0 13.5h14";
