  ...
  (this, (function(document, videojs) {
    ...
    var PlaylistMenuItem = function(_Component) {
        ...
        _proto.createEl = function createEl() {
          ...
          product_details.className = 'product-header__content__details__metadata typ-footnote-emph';
          product_details.innerHTML = item.productDetails;
          authorsinfor.appendChild(product_details);
