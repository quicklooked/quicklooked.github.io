require = function e(t, n, r) {
  ...
  4: [function(e, t, n) {
    ...
    n.HybridLoader = class extends s.EventEmitter {
      constructor(e = {}) {
        super(), this.debug = r("p2pml:hybrid-loader"), this.debugSegments = r("p2pml:hybrid-loader-segments"), this.segmentsQueue = [], this.bandwidthApproximator = new c.BandwidthApproximator, this.httpDownloadInitialTimeoutTimestamp = -1 / 0, this.processInitialSegmentTimeout = async () => {
  ...
  29: [function(e, t, n) {
    (function(n, r) {
      ...
      var l, d, f = e("./internal/streams/buffer_list"),
      ...
      function T(e, t, n, r, i) {
        ...
        if(null === t) o.reading = !1,
          ...
          if("string" == typeof t || o.objectMode || Object.getPrototypeOf(t) === a.prototype || (t = function(e) {
              return a.from(e)
            }(t)), r) o.endEmitted ? e.emit("error", new _) : R(e, o, t, !0);
  ...
  31: [function(e, t, n) {
    (function(n, r) {
      ...
      var h, l = e("./internal/streams/destroy"),
  ...
  35: [function(e, t, n) {
    ...
    t.exports = function e(t, n, s) {
      ...
      return ! function(e) {
        ...
        }(t) ? a && !t._writableState && (t.on("end", u), t.on("close", u)) : (t.on("complete", h), t.on("abort", p), t.req ? g() : t.on("request", g)), t.on("end", d), t.on("finish", h), !1 !== n.error && t.on("error", f), t.on("close", p),
        function() {
    ...
    (function(n) {
      ...
      function c(e) {
        ...
        if(t._id = o(4).toString("hex").slice(0, 7), t._debug("new peer %o", e), e = Object.assign({
            allowHalfOpen: !1
          }, e), a.Duplex.call(t, e), t.channelName = e.initiator ? e.channelName || o(20).toString("hex") : null, t.initiator = e.initiator || !1, t.channelConfig = e.channelConfig || c.channelConfig, t.config = Object.assign({}, c.config, e.config), t.offerOptions = e.offerOptions || {}, t.answerOptions = e.answerOptions || {}, t.sdpTransform = e.sdpTransform || function(e) {
            return e
      ...
      }, c.prototype._read = function() {}, c.prototype._write = function(e, t, n) {
  ...
  events: [function(e, t, n) {
    ...
    function l(e, t, n) {
      if(t) e.call(n);
        ...
        for(var r = e.length, i = v(e, r), s = 0; s < r; ++s) i[s].call(n)
    }

    function d(e, t, n, r) {
      if(t) e.call(n, r);
      else
        for(var i = e.length, s = v(e, i), o = 0; o < i; ++o) s[o].call(n, r)
    }

    function f(e, t, n, r, i) {
      if(t) e.call(n, r, i);
      else
        for(var s = e.length, o = v(e, s), a = 0; a < s; ++a) o[a].call(n, r, i)
    }

    function p(e, t, n, r, i, s) {
      if(t) e.call(n, r, i, s);
      else
        for(var o = e.length, a = v(e, o), u = 0; u < o; ++u) a[u].call(n, r, i, s)
    }

    function g(e, t, n, r) {
      if(t) e.apply(n, r);
      else
        for(var i = e.length, s = v(e, i), o = 0; o < i; ++o) s[o].apply(n, r)
    }
