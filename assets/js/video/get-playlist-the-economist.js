function getPlaylistTheEconomist() {
  ...
  return [{
    ...
    duration: '503',
    date: 'May 14',
    authors: 'Economist TV+',
    authorsImg: 'https://www.economist.com/engassets/ico/favicon.f1ea908894.ico',
    productDetails: '<div class="product-header__content__details__metadata--info"> <span>Documentary</span> <span>2021</span></div><div class="badge badge--common-sense--on-dark clr-secondary-text-on-dark" aria-label="Common Sense Recommended Age 15+" role="img"> <span aria-hidden="true">15+</span></div> <span class="badge badge--rating--vn_movies--VN_MOVIES_C13--on-dark" aria-label="Rated C13" role="img"> C13 </span> <span class="badge badge--4k--on-dark" role="img" aria-label="4K"></span> <span class="badge badge--dolby-vision--on-dark" role="img" aria-label="Dolby Vision"></span> <span class="badge badge--dolby-atmos--on-dark" role="img" aria-label="Dolby Atmos"></span> <span class="badge badge--cc--on-dark" role="img" aria-label="Closed Captioning"></span> <span class="badge badge--ad--on-dark" role="img" aria-label="Audio Descriptions"></span> <span class="badge badge--sdh--on-dark" role="img" aria-label="Subtitles for the Deaf and Hard of Hearing"></span>',
