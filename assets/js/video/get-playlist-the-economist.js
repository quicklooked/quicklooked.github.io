function getPlaylistTheEconomist() {
  ...
  return [{
    ...
    productDetails: '<span class="badge badge--4k--on-dark" role="img" aria-label="4K"></span> <span class="badge badge--dolby-vision--on-dark" role="img" aria-label="Dolby Vision"></span> <span class="badge badge--cc--on-dark" role="img" aria-label="Closed Captioning"></span> <span class="badge badge--sdh--on-dark" role="img" aria-label="Subtitles for the Deaf and Hard of Hearing"></span>',
