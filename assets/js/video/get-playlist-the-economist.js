function getPlaylistTheEconomist() {
  ...
  return [{
    ...
    authorsImg: '<div class="badge badge--common-sense--on-dark clr-secondary-text-on-dark" aria-label="Common Sense Recommended Age 15+" role="img"><span aria-hidden="true">15+</span></div>',
