/*! @name videojs-seek-buttons @version 1.6.0 @license Apache-2.0 */ ! function(o, e) {
  ...
  var s = function(o) {
    ...
    function n(e, t) {
      var n;
      return "forward" === (n = o.call(this, e, t) || this).options_.direction ? n.controlText(n.localize("Seek forward {{seconds}}s").replace("{{seconds}}", n.options_.seconds)) : "back" === n.options_.direction && n.controlText(n.localize("Seek back {{seconds}}s").replace("{{seconds}}", n.options_.seconds)), n
    }
