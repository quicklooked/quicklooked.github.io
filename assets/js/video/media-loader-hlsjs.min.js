require = function t(e, s, i) {
  ...
  5: [function(t, e, s) {
    ...
    s.SegmentManager = class {
        ...
        if(a.manifest.playlists) {
          ...
          for(const [t, e] of this.variantPlaylists) {
            const {
              ...
              found: i,
              index: n
            } = this.getStreamSwarmId(e.requestUrl);
      ...
      getStreamSwarmId(t) {
        ...
        return {
          streamSwarmId: void 0 !== e ? e : t.split("?")[0],
          found: !1,
          index: -1
        }
      }
        ...
        return e.on = function(t, e) {
          ...
          if(n)
            if(2 === arguments.length)
              for(s = n.length, e = 0; e < s; ++e) n[e].call(this, arguments[1]);
            else
              for(i = Array.prototype.slice.call(arguments, 1), s = n.length, e = 0; e < s; ++e) n[e].apply(this, i)
        }, e.dispose = function() {
          this.listeners = {}
        }, e.pipe = function(t) {
      ...
      g = function(t) {
        ...
        return s.push = function(t) {
          ...
          0 !== (t = t.trim()).length && ("#" === t[0] ? this.tagMappers.reduce(function(e, s) {
            ...
            for(var n = 0; n < i.customParsers.length; n++)
              if(i.customParsers[n].call(i, t)) return;
            if(0 === t.indexOf("#EXT"))
              if(t = t.replace("\r", ""), e = /^#EXTM3U/.exec(t)) i.trigger("data", {
                type: "tag",
                tagType: "m3u"
              });
              else {
          ...
          "function" != typeof n && (n = function(t) {
            ...
            if(s.exec(t)) return e.trigger("data", {
              type: "custom",
              data: n(t),
              customType: i,
              segment: a
          ...
          ({
            tag: function() {
              ({
                ...
                byterange: function() {
                  var e = {};
                  "length" in t && (o.byterange = e, e.length = t.length, "offset" in t || (this.trigger("info", {
                    message: "defaulting offset to zero"
                  }), t.offset = 0)), "offset" in t && (o.byterange = e, e.offset = t.offset)
                },
                endlist: function() {
                ...
                inf: function() {
                  ...
                  })), t.duration > 0 && (o.duration = t.duration), 0 === t.duration && (o.duration = .01, this.trigger("info", {
                ...
                "discontinuity-sequence": function() {
                  isFinite(t.number) ? (this.manifest.discontinuitySequence = t.number, m = t.number) : this.trigger("warn", {
                ...
                "stream-inf": function() {
                  this.manifest.playlists = r, this.manifest.mediaGroups = this.manifest.mediaGroups || c, t.attributes ? (o.attributes || (o.attributes = {}), a(o.attributes, t.attributes)) : this.trigger("warn", {
            ...
            uri: function() {
              o.uri = t.uri, r.push(o), !this.manifest.targetDuration || "duration" in o || (this.trigger("warn", {
                message: "defaulting segment duration to the target duration"
              }), o.duration = this.manifest.targetDuration), i && (o.key = i), o.timeline = m, s && (o.map = s), o = {}
            },
            comment: function() {},
            custom: function() {
  ...
  "p2p-media-loader-hlsjs": [function(t, e, s) {
    ...
    Object.defineProperty(s, "__esModule", {
      value: !0
    }), s.version = "0.6.2", i(t("./engine")), i(t("./segment-manager")), s.initHlsJsPlayer = n, s.initClapprPlayer = function(t) {
      t.on("play", () => {
