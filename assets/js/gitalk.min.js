  ...
  return function(e) {
      ...
      B = function(e) {
        ...
        return (0, y.default)(t, e), (0, d.default)(t, [{
          ...
          value: function() {
            ...
            }), b.default.createElement("span", null, this.i18n.t("please-contact", {
    ...
    */
    ...
    e.exports = {
      ...
      "login-with-github": "Sign in",
      "first-comment-person": "The Quicklook needs your voice. We welcome your on-topic commentary, criticism and expertise.",
      commented: "",
      "load-more": "Open Responses",
      counts: "Responses (%{counts})||||Responses (%{counts})",
      "sort-asc": "Sort by: Oldest",
      "sort-desc": "Sort by: Newest",
      logout: "Sign out",
      anonymous: "Anonymous"
    }
  }, function(e, t) {
    ...
    function n() {
      function e(e, n, r) {
        r = r || {};
        var o;
        return o = "string" == typeof t[e] ? t[e] : 1 === n ? t[e].one : t[e].other.replace("{{count}}", n), r.addSuffix ? r.comparison > 0 ? "" + o : o + " ago" : o
      }
      var t = {
        lessThanXSeconds: {
          one: "Just now",
