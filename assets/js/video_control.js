document.addEventListener('DOMContentLoaded', () => { 
  ...
  const player = new Plyr('#player', { debug: true , title: '' , iconUrl: '/assets/js/sprite_video.svg' , controls , settings , i18n,  speed , keyboard , tooltips , captions , vimeo , fullscreen });
