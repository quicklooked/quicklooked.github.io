document.addEventListener('DOMContentLoaded', () => { 
  const controls = ['play-large', 'mute', 'captions', 'current-time', 'progress', 'fullscreen']
  ...
  const player = new Plyr('#player', { debug: true , title: '' , iconUrl: 'https://cdn.jsdelivr.net/gh/theprojectsomething/plyr@a55bf00/demo/dist/demo.svg' , controls , settings , i18n , speed , keyboard , tooltips , captions , vimeo , fullscreen });
