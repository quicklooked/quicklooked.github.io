(self.webpackChunklite = self.webpackChunklite || []).push([
	[6230], {
		...
		33241: (t, e, n) => {
			...
			var d = (0, a.Ps)(c());
			const p = (0, u.$j)()((function(t) {
				var e = t.targetAuthorId,
					n = t.targetPostId,
					r = t.dispatch,
					o = t.children,
					a = t.onOptimisticComplete,
					u = t.isBlocking;
				return s.createElement(i.mm, {
					mutation: d,
		...
		86753: (t, e, n) => {
			...
			var k = (0, s.Ps)(A(), p.qU, c.jy),
				x = function(t) {
					return {
						fill: t.baseColor.fill.light
					}
				},
				N = function(t) {
					return {
						fill: t.baseColor.border.light,
						cursor: "default"
					}
				},
				D = function() {
			...
			function C(t) {
				...
				return u.createElement(d.Q_, null, (function(t) {
					return t ? s ? u.createElement("div", {
						className: b(x)
					}, u.createElement(c.sN, {
						post: e
					}, (function(t) {
						return u.createElement(g._, {
							isVisible: O,
							targetDistance: 10,
							tooltipText: (n = s, {
						...
						var n
					}))) : null : u.createElement(g._, {
						isVisible: O,
						placement: "top",
						targetDistance: 10,
						tooltipText: "Bookmark story"
					}, u.createElement(p.R9, {
						post: e,
						operation: "register",
						actionUrl: (0, R.XET)(S, i),
						susiEntry: a
					}, u.createElement(_.Z, {
						className: b(x)
					})))
				...
				b = function(t) {
					...
					return r ? e((function(t) {
						return function() {
							...
							throw new Error('Invalid reading list change from "'.concat(n.readingList || "unkown", '" to "').concat(t, '".'))
						}
					})) : null
				}
		},
		...
		73232: (t, e, n) => {
			...
			var r = "This story is also a response to another story. Are you sure you want to delete this story?",
				o = "This story is also a response to another story. Any edits are applied to both."
		},
		90639: (t, e, n) => {
			"use strict";
			n.d(e, {
			...
			const u = function(t) {
				var e = t.isVisible,
					...
					g = m[0],
					E = m[1],
					v = a.useCallback((function(t, e) {
						return E(e)
					}), []);
				return a.createElement(i.Vq, {
					isVisible: e,
					hide: n,
					noPortal: u,
					withCloseButton: !1,
					customBackgroundColor: u ? "rgba(255, 255, 255, 0.97)" : "rgba(255, 255, 255, 0.94)"
				...
				}, a.createElement(s.X6, {
					scale: "M"
				}, "Report ", u ? "Response" : "Story"), a.createElement(i.xu, {
					display: "flex",
					flexDirection: "column",
					width: "100%",
					paddingRight: "5px",
					...
					paddingTop: u ? "16px" : "0"
				}, "Also block the author of this ", u ? "response" : "story"))), a.createElement(i.xu, {
					display: "flex",
					justifyContent: "center",
					marginBottom: "10px"
				}, a.createElement(i.xu, {
					...
					target: "_blank",
					inline: !0
				}, "our rules"), "."))), !u && a.createElement(i.PZ, {
					onClick: n,
					size: "LARGE",
					absoluteOffset: "18px"
				})))
			...
			var u = a.createContext({}),
				...
				c = function(t) {
					var e = t.context,
						...
						o = t.children,
						i = l();
					return r && i && (e = s(s({}, i), e)), a.createElement(u.Provider, {
						value: e
					}, o)
				}
		},
